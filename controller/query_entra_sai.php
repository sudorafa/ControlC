...
if ($movimento_user1 == "USO"){
	...
	$query2 = "update usuariosc set capa = '$capa1', termo = '$termo1' where matricula = '$matricula1' and filial = '$filial_usuario_logado'";
	...
	$query3 = "update coletores set id_mov = '$id2', status = 'CPD' where identificador = '$coletor_uso1' and filial = '$filial_usuario_logado'";
	...
	$query4 = "update usuariosc set capa = '$capa1', termo = '$termo1' where matricula = '$matricula1' and filial = '$filial_usuario_logado'";
	...
	$query5 = "update mov_coletores set matricula_user = '$matricula1', nome_user = '$nome1', setor_user = '$setor1', data_saida = '$data_saida1', hora_saida = '$hora_saida1', obs_saida = '$obs_saida1', movimento = 'USO' where coletor = '$coletor1' and movimento = 'LIVRE' and filial = '$filial_usuario_logado'";
	if( mysql_query($query5)) {} 
	else {
		echo 
		"<script>window.alert('Algo Errado no Query 5')
			window.location.replace('../home.php');
		</script>";
	}
	
	$query6 = "update coletores set status = '$setor1' where identificador = '$coletor1' and filial = '$filial_usuario_logado'";
	if( mysql_query($query6)) {
		...
		echo 
		"<script>window.alert('Algo Errado no Query 6')
			window.location.replace('../home.php');
		</script>";
